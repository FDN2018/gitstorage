...
router.get('/billzone',(req, res)=> {
    res.render('billzone');
});
router.get('/proddet',(req, res)=> {
    res.render('proddet');
});
router.get('/billcusdet',(req, res)=> {
    res.render('billcusdet');
});
router.get('/price',(req, res)=> {
    res.render('price');
});
router.get('/viewprice',(req, res)=> {
    res.render('viewprice');
});
router.get('/priceinfo',(req, res)=> {
    res.render('priceinfo');
});
...
router.get('/lcozonetra',(req, res)=> {
    res.render('lcozonetra');
});
router.get('/lcopricedet',(req, res)=> {
    res.render('lcopricedet');
});
