...
function colVal(val){
    ...
    var getData=(document.getElementById("testinp").value)+regex;          
                    ...
                    else if(colval=="crd" && condDval=="equal"){
                       var getData=document.getElementById("testdateinp1").value;
                       var i=4;
                    }
                    else if(colval=="crd" && condDval=="lessequal"){
                       var getData=document.getElementById("testdateinp1").value;
                       var i=4;
                    }
                    else if(colval=="crd" && condDval=="gtequal"){
                       var getData=document.getElementById("testdateinp2").value;
                       var i=4;
                    }
                    else if(colval=="crd" && condDval=="notequal"){
                       var getData=document.getElementById("testdateinp1").value;
                    }
                    else if(colval=="crd" && condDval=="between"){
                       var getData=document.getElementById("testinp").value;
                       var i=4;
                    }
                    else if(colval=="crd" && condDval=="thisweek"){
                    var currentDate = new Date();
                    var firstday = new Date(currentDate.setDate(currentDate.getDate()+1 - currentDate.getDay())).toUTCString();
                    var lastday = new Date(currentDate.setDate(currentDate.getDate() - currentDate.getDay() + 7)).toUTCString();
                    var firstdate = new Date(firstday).toLocaleDateString('en-IN',{undefined,year: "numeric",month: "2-digit",day: "2-digit",}).split( '/' ).reverse( ).join( '-' );
                    ...
                    else if(colval=="ip" && condval=="any"){
                       var i=8;
                       var getData=document.getElementById("testinp").value;
                    }
                    else if(colval=="ip" && condval=="startwith"){
                       var i=8;
                       var regex='^';
                    var getData=regex+(document.getElementById("testinp").value);          
                    }
                    else if(colval=="ip" && condval=="endwith"){
                       var i=8;
                       var regex='*$';
                    var getData=(document.getElementById("testinp").value)+regex;          
                    }
                    else if(colval=="ip" && condval=="exactly"){
                       var i=8;
                       var sregex='^';
                       var eregex='*$';
                    var getData=sregex+(document.getElementById("testinp").value)+eregex;          
                    }
                    else if(colval=="ip" && condval=="notlike"){
                    var i=8;
                    var getData=document.getElementById("testinp").value;          
                    }
                    
                    else if(colval=="status" && condval=="any"){
                       var i=9;
                       var getData=document.getElementById("testinp").value;
                    }
                    else if(colval=="status" && condval=="startwith"){
                       var i=9;
                       var regex='^';
                    var getData=regex+(document.getElementById("testinp").value);          
                    }
                    else if(colval=="status" && condval=="endwith"){
                       var i=9;
                       var regex='*$';
                    var getData=(document.getElementById("testinp").value)+regex;          
                    }
                    else if(colval=="status" && condval=="exactly"){
                       var i=9;
                       var sregex='^';
                       var eregex='*$';
                    var getData=sregex+(document.getElementById("testinp").value)+eregex;          
                    }
                    else if(colval=="status" && condval=="notlike"){
                    var i=9;
                    var getData=document.getElementById("testinp").value;          
                    }
